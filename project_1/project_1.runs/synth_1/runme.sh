...
HD_PWD='C:/Users/Amritha K Poojari/OneDrive/Desktop/fizbo/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hex_bcd_counter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hex_bcd_counter.tcl
