...
HD_PWD='C:/Users/Amritha K Poojari/OneDrive/Desktop/fizbo/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log hex_bcd_counter.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source hex_bcd_counter.tcl -notrace
